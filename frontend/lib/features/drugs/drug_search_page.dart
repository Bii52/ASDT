          ...
          items: DrugSortBy.values.map((v) {
            return DropdownMenuItem(
              ...
              child: Row(
                ...
                children: [
                  Icon(_iconOf(v), size: 18, color: c.primary),
                  const SizedBox(width: 6),
                  Text(_labelOf(v), style: t.bodyMedium),
                ],
              ),
            );
          }).toList(),
          selectedItemBuilder: (ctx) {
            return DrugSortBy.values.map((v) {
              return Row(
                mainAxisSize: MainAxisSize.min,
                children: [
                  Icon(_iconOf(sortBy), size: 18, color: c.primary),
                  const SizedBox(width: 6),
                  Text(_labelOf(sortBy), style: t.bodyMedium?.copyWith(fontWeight: FontWeight.w600)),
                ],
              );
            }).toList();
          },
